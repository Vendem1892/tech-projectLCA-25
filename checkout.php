        ...
        ?>
            <div class='bg-slate-400 font-normal static col-span-3' id='cart'>
                ...
                <ul class=''>
                    <li>
                        <div class=''>
                            <img href='<?php echo $img ?>' alt='<?php echo $imgAlt1 ?>' class='min-h-40 max-h-40 overflow-hidden shadow-lg'>
                            <hr>
                            <div class="float-left md:text-clip">
                                <h4 class=""><?php echo $iTitle ?></h4>
                                <br>                                
            ...
            <script>
                var orderPrice = <?php echo $priceUS ?>
