    ...
    <br><br>    
        ...
        <form action="../includes/listing_handler.php" onsubmit="return listingValidation()" method="post">
                ...
                <br><br>
                    ...
                    <input type="text" name="img1_fName" id="img1_fName" class="hidden">
                ...
                <br><br>
                    ...
                    <input type="text" name="img2_fName" id="img2_fName" class="hidden">
                ...
                <br><br>
                    ...
                    <input type="text" name="img3_fName" id="img3_fName" class="hidden">
                <br><br>
